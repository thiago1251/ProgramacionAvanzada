...
SELECT Fuentes.Nombre, proyectos.Nombre, monto
FROM  (financiacion_proyectos INNER JOIN proyectos
ON financiacion_proyectos.idProyecto = proyectos.idProyecto)
INNER JOIN fuentes
ON financiacion_proyectos.idFuente= fuentes.idFuente;
